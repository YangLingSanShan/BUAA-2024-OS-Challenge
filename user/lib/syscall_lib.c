...
int syscall_getStatus(u_int envid) {
	return msyscall(SYS_getStatus, envid);
}

void syscall_changeEnv(u_int envid) {
	return msyscall(SYS_changeEnv, envid);
}

void syscall_set_res(int res) {
	return msyscall(SYS_set_res, res);
}

int syscall_get_res(u_int envid) {
	return msyscall(SYS_get_res, envid);
}
